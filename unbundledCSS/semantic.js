      ...
      module = {
        ...
        queryRemote: function(query, callback) {
          ...
          return function makeComp(input) {
            for (var i = 0; i < rplc.length; i++)
              input = input.replace(new RegExp(rplc[i],'g'), rplc[i]);
            return input;
          };
        }()),
        ...
        filterItems: function(query) {
          ...
          // escapedTerm      = module.escape.string(searchTerm),
              escapedTerm      = module.makeCompItems(module.escape.string(searchTerm)),
              beginsWithRegExp = new RegExp('^' + escapedTerm, 'igm'),
          //added
              containsRegExp = escapedTerm ? new RegExp(escapedTerm + '{1,}', 'igm'): beginsWithRegExp
              ;
          ...
          if( module.has.query() ) {
            ...
            $item
                .each(function(){
                  ...
                  //added
                  else if (settings.fullTextSearch === 'exact' && (containsRegExp.test(text))) {
                    results.push(this);
                    return true;
                  }
                  }
                  if(settings.match == 'both' || settings.match == 'value') {
                    ...
                    //added
                    else if (settings.fullTextSearch === 'exact' && (containsRegExp.test(value))) {
                      results.push(this);
                      return true;
                    }
                  }
